          ...
          {[
            ...
            >
              <div className="flex justify-between items-center">
                {item.link === "" ? (
                  <p className="font-semibold text-blue-600 dark:text-blue-400 cursor-pointer text-sm md:text-lg uppercase">
                    {item.name}
                  </p>
                ) : (
                  <a
                    className="font-semibold text-blue-600 dark:text-blue-400 hover:underline text-sm md:text-lg uppercase"
                    href={item.link}
                    target="_blank"
