...
const ProjectDetails = () => {
  ...
  const jsonLd = project
    ? {
        ...
        sameAs: [project.gitHubLink, project.liveLink],
        creator: {
          "@type": "Person",
          name: "Hardik Daim",
        },
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://hardik-daim.vercel.app/project/details/${projectId}`}
        />
        <meta
          name="description"
          content={
        ...
        <meta
          property="og:url"
          content={`https://hardik-daim.vercel.app/project/details/${projectId}`}
        />
